...
urlpatterns = [
    ...
    path('utmerkelse/<int:uid>/fjern/',
         views.view_utmerkelse_fjern, name='utmerkelse_fjern'),
    ...
    path('produksjon/<int:pid>/endre/',
         views.view_produksjon_endre, name='produksjon_endre'),
    path('produksjon/<int:pid>/slett/',
         views.view_produksjon_slett, name='produksjon_slett'),
    path('numre/', views.view_numre, name='numre'),
    path('nummer/<int:nid>/', views.view_nummer_info, name='nummer_info'),
    path('forestilling/<int:fid>/fjern/',
         views.view_forestilling_fjern, name='forestilling_fjern'),
    path('anmeldelse/<int:aid>/fjern/',
         views.view_anmeldelse_fjern, name='anmeldelse_fjern'),
    ...
    path('erfaring/<int:eid>/fjern/',
         views.view_erfaring_fjern, name='erfaring_fjern'),
    ...
    path('ar/<int:arstall>/nyttkull/',
         views.view_ar_nyttkull, name='ar_nyttkull'),
